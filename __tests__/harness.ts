...
describe('harness', () => {
    ...
    test('normalizeZipCode rejects invalid zip code', () => {
        expect(() => normalizeZipCode('abcde')).toThrow('ZIP code must contain exactly 5 digits (e.g. 10115)');
        expect(() => normalizeZipCode('1234')).toThrow('ZIP code must contain exactly 5 digits (e.g. 10115)');
    });
